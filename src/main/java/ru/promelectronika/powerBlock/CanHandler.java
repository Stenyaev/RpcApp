...
import ru.promelectronika.powerBlock.PowerBlock.MessageType;

import java.util.ArrayList;

import static ru.promelectronika.powerBlock.PowerBlock.CommandType;
...
public class CanHandler {
    ...
    private static void setParameter(PowerBlock block, byte msgType, byte[] data) {
        ...
        for (MessageType aType: MessageType.values()) {
            ...
            try {
                switch (messageType) {
                    ...
                    case READ_SERIAL_NUMBER_RESPONSE:
                        ...
                        for (CommandType aType : CommandType.values()) {
