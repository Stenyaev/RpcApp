...
public class GbtClient extends RpcClient {
    ...
    private static final String INTERFACE_ID = "IID_SECC_GBT_2.0";
    ...
    public GbtClient(PowerBlock powerBlock) throws IOException {
        super(ADDRESS, PORT);
    ...
    public void rpcConnectRequest(String remoteAddress, int remotePort) {
        ...
        ErrorHandler.loggerClientGbt.info("rpcConnectRequest: {}", str.toString());
    }
    ...
    public void rpcPing() {
        ...
        str.append(2);
        ErrorHandler.loggerClientGbt.debug("rpcPing: {}", str.toString());
    }

    public void rpcSetInvertorLimits() {
        Object[] arg = {maxPowerLimit, MAX_VOLTAGE_LIMIT, MAX_CURRENT_LIMIT,
        ...
        ErrorHandler.loggerClientGbt.info("rpcSetInvertorLimits: {}", str.toString());
    }
    public void rpcSetInvertorPresentsParams() {
        ...
        str.append("\n\tPresent Current: ");
        str.append(i);
        ErrorHandler.loggerClientGbt.info("rpcSetInvertorPresentsParams: {}", str.toString());
    ...
    public void rpcSetIsolationState() {
        ...
        ErrorHandler.loggerClientGbt.info("rpcSetIsolationState: {}", str.toString());
    }
    public void rpcAuthorize() {
        ...
        ErrorHandler.loggerClientGbt.info("rpcAuthorize");
    }
    public void rpcUserStop() {
        ...
        ErrorHandler.loggerClientGbt.info("rpcUserStop");
    }
